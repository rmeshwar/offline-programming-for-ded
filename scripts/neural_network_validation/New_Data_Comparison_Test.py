...
# File paths
NEW_SAMPLES_PATH = 'data/8_New_Samples.xlsx'  # New data samples
...
OUTPUT_LOG = open('logs/comparison/new_samples_comparison.txt', 'w', encoding='utf-8')
...
def evaluate_model_on_new_samples(model_path, scaler_path):
    ...
    print(f"Using dataset: 8 New Samples")
...
comparison_summary.to_csv('logs/comparison/new_samples_summary.csv')
