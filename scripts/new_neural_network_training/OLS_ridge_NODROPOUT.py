...
# Create directories if they don't exist for logs, saved models, and images
os.makedirs('logs/neural/OLS_ridge_NODROPOUT', exist_ok=True)
os.makedirs('saved_models/OLS_ridge_NODROPOUT', exist_ok=True)
os.makedirs('images/neural/OLS_ridge_NODROPOUT', exist_ok=True)
...
output_file = open('logs/neural/OLS_ridge_NODROPOUT/neural_network_output.txt', 'w', encoding='utf-8')
...
# Plot training history and save it to the specified directory
...
plt.legend()
plt.savefig('images/neural/OLS_ridge_NODROPOUT/training_validation_loss.png')
plt.show()
...
keras_model_path = 'saved_models/OLS_ridge_NODROPOUT/neural_network_model.keras'
model.save(keras_model_path)
print(f"Model saved to {keras_model_path}")

# Save the model in HDF5 format if needed
h5_model_path = 'saved_models/OLS_ridge_NODROPOUT/neural_network_model.h5'
model.save(h5_model_path)
print(f"Model saved to {h5_model_path}")

# Save the scaler
scaler_path = 'saved_models/OLS_ridge_NODROPOUT/scaler.pkl'
